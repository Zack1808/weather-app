...
// Creating the TemperatureAndDetails component
const TemperatureAndDetails = () => {
    return(
        <div>
            <div className="flex items-center justify-center py-6 text-xl text-cyan-300">Cloudy</div>
                ...
                <div className='flex flex-col space-y-2'>
                    <div className='flex font-light text-sm items-center justify-center'>
                        ...
                        Real feel: <span className='font-medium ml-1'> 32°C</span>
                    </div>
                    <div className='flex font-light text-sm items-center justify-center'>
            ...
            <div className='flex flex-row items-center justify-center space-x-2 text-white text-sm py-3'>
                ...
                <UilSunset />
                <p className='font-light'>Set: <span className='font-medium ml-1'>07:37 PM</span></p>
                <p className='font-light'>|</p>
